...
if __name__ == '__main__':
    ...
    save_fold = 'gargoyle_sup30'
    net = build_network(input_dim=3)
    net.to(device)
    net.load_state_dict(torch.load('./models/' + save_fold + '/model_final.pth', map_location=device))
    ...
    o3d.io.write_triangle_mesh('output/' + save_fold + '/mesh_40.ply', mesh)
